...
def are_all_expectations_met(similarity_chunks: list[Chunk], expectations: list[Expectation]) -> bool:
    return not any(not is_expectation_met(similarity_chunks, exp) for exp in expectations)
